:sample-project: jmix-openapi-integration-sample
...
* Select *OpenAPI* -> *petclinic* -> *API* -> *SpecialtyApi* node in the Jmix tool window and click *Create Service* in its context menu:
+
